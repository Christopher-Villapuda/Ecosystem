...
public class C2E1 : MonoBehaviour
{
    ...
    void Start()
    {
        mover = new Mover2_1(moverSpawnTransform.position, leftWallX, rightWallX, floorY, ceilingY);
    }
...
public class Mover2_1
{
    ...
    public Mover2_1(Vector3 position, float xMin, float xMax, float yMin, float yMax)
    {
        this.xMin = xMin;
        this.xMax = xMax;
        this.yMin = yMin;
