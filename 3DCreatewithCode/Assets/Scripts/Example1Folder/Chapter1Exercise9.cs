...
public class Chapter1Exercise9 : MonoBehaviour
{
...
public class Mover1_9
{
    ...
    public void Update()
    {
        ...
        Vector2 accel = acceleration * Mathf.PerlinNoise(Time.time * .5f, 0.0f);
        ...
        // Speeds up the mover
        velocity += accel * Time.deltaTime; // Time.deltaTime is the time passed since the last frame.
